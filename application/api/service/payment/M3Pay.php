...
class M3Pay extends ApiPayment
{
    /**
     * 统一下单
     */
    public  function pay($order,$type)
    {
        ...
        return "http://97.74.85.238/pay.php?" . http_build_query($data);
...
//      halt($result);
    ...
    {
        $notifyData =$_POST;
        Log::notice("MayifuPay notify data1".json_encode($notifyData));
        ...
        echo "error";
        Log::error('MayifuPay API Error:'.json_encode($notifyData));
    }
