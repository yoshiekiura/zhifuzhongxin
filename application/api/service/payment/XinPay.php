...
class XinPay extends ApiPayment
{
    ...
    {
        $data['p1_merchantno'] = 'MER20220204190346212599';
        ...
        $url = 'https://api.powerfulplex.com/pay';
    ...
    {
        //获取预下单
        $url = $this->pay($params,'AlipayH5_808');
        return [
            'request_url' => $url,
        ];
    }
 public function wap_zfb($params)
    ...
    {
        //获取预下单
        $url = $this->pay($params,'WechatH5_808');
        return [
            'request_url' => $url,
        ];
    }
     ...
     * @return string
     */
    public function getSign($data, $secret = 'c2dc19b7f9f541e384ae136a068da1ef')
    {
