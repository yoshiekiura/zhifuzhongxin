...
$data = db()->query('select o.trade_no,e.notify_url from cm_ewm_order as e left join cm_orders as o on o.trade_no = e.order_no  where e.status=1 and e.add_time>unix_timestamp(now())-60*60*24 and o.status=1 order by o.create_time desc limit 100');
var_dump($data);
