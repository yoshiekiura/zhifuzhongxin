...
class Balance extends BaseAdmin
{
    ...
    {
        //总商户资产统计
        $this->assign('balance', $this->logicBalance->getBalaceStat());
        return $this->fetch();
    }
    ...
    public function getList()
    {
        ...
        $data = $this->logicBalance->getBalanceList($where, true, $sort, input('limit'));
    ...
    public function paidList()
    {
        ...
        $data = $this->logicBalanceCash->getOrderCashList($where, 'a.*,u.account,u.account_name,b.name as method,pc.name as channel_name', 'a.create_time desc', input('limit'));
