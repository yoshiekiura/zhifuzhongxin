...
Route::rule('apis/query','api/Pay/query');//查询地址
...
Route::get('exportBalanceCashByadmin','admin/Balance/exportBalanceCash');
Route::get('exportBalance','admin/Balance/exportBalance');
